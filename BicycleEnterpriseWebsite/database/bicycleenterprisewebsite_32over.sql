...
CREATE TABLE `bk_cate` (
  ...
  `type` int(10) DEFAULT '1' COMMENT '栏目分类：代表1、文章栏目 2、单页栏目 3、图片列表',
...
INSERT INTO `bk_cate` VALUES ('12', '上海', '3', '1', '50');
...
INSERT INTO `bk_cate` VALUES ('22', '湖北', '3', '1', '50');
...
CREATE TABLE `bk_link` (
  ...
  `ltitle` varchar(255) DEFAULT NULL COMMENT '链接标题',
  `ldesc` varchar(255) DEFAULT NULL COMMENT '链接描述',
  `lurl` varchar(255) DEFAULT NULL COMMENT '链接的url',
  `lsort` int(11) DEFAULT '50' COMMENT '链接的排序字段',
  PRIMARY KEY (`lid`)
...
-- Records of bk_link
-- ----------------------------
INSERT INTO `bk_link` VALUES ('1', '百度', '百度: www.baidu.com', 'www.baidu.com', '6');
INSERT INTO `bk_link` VALUES ('2', '百度', '百度: www.baidu.com', 'www.baidu.com', '5');
INSERT INTO `bk_link` VALUES ('3', '百度', '百度: www.baidu.com', 'www.baidu.com', '7');
INSERT INTO `bk_link` VALUES ('4', 'B站', 'B站：http://space.bilibili.com', 'http://space.bilibili.com', '43');
INSERT INTO `bk_link` VALUES ('6', '淘宝', '淘宝：www.taobao.cao', 'www.taobao.cao', '0');
